...
RepositoryDomainPackage.$inject = ['CoreModelPackage', 'eventAggregator', '$localForage', '$q', '$log']
...
# ** The data model is defined by subclassing DocumentModelPackage.Document and binding that subclass to a
...
# WHERE DOES THIS BELONG (End)
  ...
  #
  # An dehydrated Folder can be used to idenitfy itself in a catalog listing, but has incomplete information
