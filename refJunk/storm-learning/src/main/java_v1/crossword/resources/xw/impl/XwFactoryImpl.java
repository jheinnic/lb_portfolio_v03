...
public class XwFactoryImpl extends EFactoryImpl implements XwFactory {
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case XwPackage.PENDING_TICKET_DETAIL: return createPendingTicketDetail();
            case XwPackage.PUBLISHED_TICKET_DETAIL: return createPublishedTicketDetail();
            case XwPackage.BOARD_COVERAGE: return createBoardCoverage();
            case XwPackage.BONUS_WORD_COVERAGE: return createBonusWordCoverage();
            case XwPackage.GRID_WORD_COVERAGE: return createGridWordCoverage();
            case XwPackage.REVEALED_INFORMATION: return createRevealedInformation();
            case XwPackage.PRIZE_ANALYSIS: return createPrizeAnalysis();
            case XwPackage.PLAYABLE_TICKET: return createPlayableTicket();
            case XwPackage.RESOLVED_TICKET: return createResolvedTicket();
            default:
    ...
    public Object createFromString(EDataType eDataType, String initialValue) {
        switch (eDataType.getClassifierID()) {
            case XwPackage.BONUS_VALUE:
                return createBonusValueFromString(eDataType, initialValue);
            default:
    ...
    public String convertToString(EDataType eDataType, Object instanceValue) {
        switch (eDataType.getClassifierID()) {
            case XwPackage.BONUS_VALUE:
                return convertBonusValueToString(eDataType, instanceValue);
            default:
                throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
        }
    }
