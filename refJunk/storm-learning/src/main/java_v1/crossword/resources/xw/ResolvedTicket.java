...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Resolved Ticket</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#getFixedDetails <em>Fixed Details</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#getBoardContent <em>Board Content</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#getBonusWord <em>Bonus Word</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#isTwentySpotIncluded <em>Twenty Spot Included</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#getLetterPool <em>Letter Pool</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#isTwentySpotPaid <em>Twenty Spot Paid</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#getBonusValue <em>Bonus Value</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#getPayoutTier <em>Payout Tier</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.ResolvedTicket#getBoardCoverage <em>Board Coverage</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ResolvedTicket extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Payout Tier</b></em>' attribute.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Payout Tier</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
