...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Playable Ticket</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#getFixedDetails <em>Fixed Details</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#getBoardContent <em>Board Content</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#getBonusWord <em>Bonus Word</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#isTwentySpotIncluded <em>Twenty Spot Included</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#getDynamicInput <em>Dynamic Input</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#getLatestAnalysis <em>Latest Analysis</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#getBoardCoverage <em>Board Coverage</em>}</li>
...
public interface PlayableTicket extends EObject {
    /**
     * Returns the value of the '<em><b>Fixed Details</b></em>' containment reference.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Fixed Details</em>' containment reference isn't clear,
    ...
    /**
     * Sets the value of the '{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#getDynamicInput <em>Dynamic Input</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Dynamic Input</em>' containment reference.
     * @see #getDynamicInput()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Latest Analysis</b></em>' containment reference.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Latest Analysis</em>' containment reference isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
    ...
    /**
     * Sets the value of the '{@link info.jchein.sandbox.app.crossword.resources.xw.PlayableTicket#getLatestAnalysis <em>Latest Analysis</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Latest Analysis</em>' containment reference.
    ...
    /**
     * Returns the value of the '<em><b>Board Coverage</b></em>' containment reference.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Board Coverage</em>' containment reference isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
