...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Async Prize Analysis Request</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.AsyncPrizeAnalysisRequestImpl#getTicketHref <em>Ticket Href</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.AsyncPrizeAnalysisRequestImpl#getRevealedInfo <em>Revealed Info</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.AsyncPrizeAnalysisRequestImpl#getBoardCoverage <em>Board Coverage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AsyncPrizeAnalysisRequestImpl extends MinimalEObjectImpl.Container implements AsyncPrizeAnalysisRequest {
    /**
     ...
     * @generated
     */
    protected AsyncPrizeAnalysisRequestImpl() {
        super();
    }
    ...
    public void setTicketHref(String newTicketHref) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PrizecalcPackage.ASYNC_PRIZE_ANALYSIS_REQUEST__TICKET_HREF, oldTicketHref, ticketHref));
    }
    ...
    public RevealedInformation getRevealedInfo() {
        if (revealedInfo != null && revealedInfo.eIsProxy()) {
            ...
            if (revealedInfo != oldRevealedInfo) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrizecalcPackage.ASYNC_PRIZE_ANALYSIS_REQUEST__REVEALED_INFO, oldRevealedInfo, revealedInfo));
            }
        }
        return revealedInfo;
    }
    ...
    public void setRevealedInfo(RevealedInformation newRevealedInfo) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PrizecalcPackage.ASYNC_PRIZE_ANALYSIS_REQUEST__REVEALED_INFO, oldRevealedInfo, revealedInfo));
    }
    ...
    public BoardCoverage getBoardCoverage() {
        if (boardCoverage != null && boardCoverage.eIsProxy()) {
            ...
            if (boardCoverage != oldBoardCoverage) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrizecalcPackage.ASYNC_PRIZE_ANALYSIS_REQUEST__BOARD_COVERAGE, oldBoardCoverage, boardCoverage));
            }
        }
    ...
    public void setBoardCoverage(BoardCoverage newBoardCoverage) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PrizecalcPackage.ASYNC_PRIZE_ANALYSIS_REQUEST__BOARD_COVERAGE, oldBoardCoverage, boardCoverage));
    }
