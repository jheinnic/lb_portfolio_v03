...
public class PrizecalcFactoryImpl extends EFactoryImpl implements PrizecalcFactory {
    ...
    public static PrizecalcFactory init() {
        try {
            PrizecalcFactory thePrizecalcFactory = (PrizecalcFactory)EPackage.Registry.INSTANCE.getEFactory(PrizecalcPackage.eNS_URI);
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case PrizecalcPackage.ASYNC_PRIZE_ANALYSIS_REQUEST: return createAsyncPrizeAnalysisRequest();
            case PrizecalcPackage.ASYNC_PRIZE_ANALYSIS_RESPONSE: return createAsyncPrizeAnalysisResponse();
            case PrizecalcPackage.REPORT_PRIZE_ANALYSIS_REQUEST: return createReportPrizeAnalysisRequest();
            case PrizecalcPackage.REPORT_PRIZE_ANALYSIS_RESPONSE: return createReportPrizeAnalysisResponse();
            case PrizecalcPackage.AVAILABLE_LETTER: return createAvailableLetter();
            case PrizecalcPackage.TICKET_STATE: return createTicketState();
            case PrizecalcPackage.BEGIN_CALCULATION: return createBeginCalculation();
            case PrizecalcPackage.SUBTASK_REQUEST: return createSubtaskRequest();
            case PrizecalcPackage.SUBTASK_RESPONSE: return createSubtaskResponse();
            case PrizecalcPackage.TASK_RESULT: return createTaskResult();
            default:
