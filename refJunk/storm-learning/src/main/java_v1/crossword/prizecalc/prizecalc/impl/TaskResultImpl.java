 ...
 * <ul>
 *   <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.TaskResultImpl#getTaskId <em>Task Id</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.TaskResultImpl#getTicketHref <em>Ticket Href</em>}</li>
 *   <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.TaskResultImpl#getReport <em>Report</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
        ...
        if (report != null && report.eIsProxy()) {
            ...
            if (report != oldReport) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrizecalcPackage.TASK_RESULT__REPORT, oldReport, report));
            }
        }
        return report;
    }
