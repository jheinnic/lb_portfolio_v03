...
public interface XwFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Pending Ticket Detail</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Published Ticket Detail</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Board Coverage</em>'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Bonus Word Coverage</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Grid Word Coverage</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Revealed Information</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Prize Analysis</em>'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Playable Ticket</em>'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Resolved Ticket</em>'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
