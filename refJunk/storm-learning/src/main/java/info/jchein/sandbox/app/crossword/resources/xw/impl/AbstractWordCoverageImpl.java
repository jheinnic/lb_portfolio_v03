...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Abstract Word Coverage</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.AbstractWordCoverageImpl#getRawWord <em>
 * Raw Word</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.AbstractWordCoverageImpl#getDisplayWord
 * <em>Display Word</em>}</li>
 * <li>
 * {@link info.jchein.sandbox.app.crossword.resources.xw.impl.AbstractWordCoverageImpl#getUncoveredLetters
 * <em>Uncovered Letters</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public abstract class AbstractWordCoverageImpl extends MinimalEObjectImpl.Container
    implements
        AbstractWordCoverage {
    /**
     * The default value of the '{@link #getRawWord() <em>Raw Word</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getRawWord()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getRawWord() <em>Raw Word</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getRawWord()
     * @generated
     ...
     * @generated
     */
    public AbstractWordCoverageImpl( ) {
        super();
    }
     ...
     * @generated
     */
    public void setRawWord( String newRawWord ) {
        String oldRawWord = rawWord;
        rawWord = newRawWord;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.ABSTRACT_WORD_COVERAGE__RAW_WORD,
                oldRawWord,
                rawWord));
    }
     ...
     * @generated
     */
    public void setDisplayWord( String newDisplayWord ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.ABSTRACT_WORD_COVERAGE__DISPLAY_WORD,
                oldDisplayWord,
                displayWord));
    }
    ...
    public void eSet( int featureID, Object newValue ) {
        switch (featureID) {
            case XwPackage.ABSTRACT_WORD_COVERAGE__RAW_WORD :
                setRawWord((String) newValue);
                return;
            case XwPackage.ABSTRACT_WORD_COVERAGE__DISPLAY_WORD :
                setDisplayWord((String) newValue);
                return;
        }
        super.eSet(
            featureID,
    ...
    public void eUnset( int featureID ) {
        switch (featureID) {
            case XwPackage.ABSTRACT_WORD_COVERAGE__RAW_WORD :
                setRawWord(RAW_WORD_EDEFAULT);
                return;
            case XwPackage.ABSTRACT_WORD_COVERAGE__DISPLAY_WORD :
                setDisplayWord(DISPLAY_WORD_EDEFAULT);
                return;
        }
    ...
    public boolean eIsSet( int featureID ) {
        switch (featureID) {
            ...
            case XwPackage.ABSTRACT_WORD_COVERAGE__DISPLAY_WORD :
                return DISPLAY_WORD_EDEFAULT == null
                    ? displayWord != null
                    : !DISPLAY_WORD_EDEFAULT.equals(displayWord);
            case XwPackage.ABSTRACT_WORD_COVERAGE__UNCOVERED_LETTERS :
                return UNCOVERED_LETTERS_EDEFAULT == null
                    ? getUncoveredLetters() != null
                    : !UNCOVERED_LETTERS_EDEFAULT.equals(getUncoveredLetters());
        }
