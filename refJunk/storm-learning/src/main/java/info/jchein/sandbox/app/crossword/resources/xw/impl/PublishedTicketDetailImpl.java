...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Published Ticket Detail</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PublishedTicketDetailImpl#getBoardContent
 * <em>Board Content</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PublishedTicketDetailImpl#getBonusWord
 * <em>Bonus Word</em>}</li>
 * <li>
 * {@link info.jchein.sandbox.app.crossword.resources.xw.impl.PublishedTicketDetailImpl#isTwentySpotIncluded
...
public class PublishedTicketDetailImpl extends MinimalEObjectImpl.Container implements PublishedTicketDetail {
     ...
     * @generated
     */
    public PublishedTicketDetailImpl( ) {
        super();
    }
    ...
    public void setBoardContent( String newBoardContent ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PUBLISHED_TICKET_DETAIL__BOARD_CONTENT,
                oldBoardContent,
                boardContent));
    }
    ...
    public void setBonusWord( String newBonusWord ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PUBLISHED_TICKET_DETAIL__BONUS_WORD,
                oldBonusWord,
                bonusWord));
    }
    ...
    public void setTwentySpotIncluded( boolean newTwentySpotIncluded ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PUBLISHED_TICKET_DETAIL__TWENTY_SPOT_INCLUDED,
    ...
    public void eUnset( int featureID ) {
        switch (featureID) {
            case XwPackage.PUBLISHED_TICKET_DETAIL__BOARD_CONTENT :
                ...
                return;
            case XwPackage.PUBLISHED_TICKET_DETAIL__BONUS_WORD :
                setBonusWord(BONUS_WORD_EDEFAULT);
                return;
            case XwPackage.PUBLISHED_TICKET_DETAIL__TWENTY_SPOT_INCLUDED :
                setTwentySpotIncluded(TWENTY_SPOT_INCLUDED_EDEFAULT);
                return;
        }
