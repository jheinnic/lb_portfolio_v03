...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Playable Ticket</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PlayableTicketImpl#getFixedDetails <em>
 * Fixed Details</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PlayableTicketImpl#getBoardContent <em>
 * Board Content</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PlayableTicketImpl#getBonusWord <em>Bonus
 * Word</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PlayableTicketImpl#isTwentySpotIncluded
 * <em>Twenty Spot Included</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PlayableTicketImpl#getDynamicInput <em>
 * Dynamic Input</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PlayableTicketImpl#getLatestAnalysis <em>
 * Latest Analysis</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PlayableTicketImpl#getBoardCoverage <em>
 * Board Coverage</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PlayableTicketImpl#isResolved <em>Resolved
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class PlayableTicketImpl extends MinimalEObjectImpl.Container implements PlayableTicket {
    ...
    /**
     * The cached value of the '{@link #getLatestAnalysis() <em>Latest Analysis</em>}' containment
    ...
    public NotificationChain basicSetFixedDetails( PublishedTicketDetail newFixedDetails, NotificationChain msgs ) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PLAYABLE_TICKET__FIXED_DETAILS,
                oldFixedDetails,
                newFixedDetails);
            if (msgs == null)
                msgs = notification;
        ...
        if (newFixedDetails != fixedDetails) {
            ...
            if (fixedDetails != null)
                msgs = ((InternalEObject) fixedDetails).eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - XwPackage.PLAYABLE_TICKET__FIXED_DETAILS,
                    null,
                    msgs);
    ...
    public NotificationChain basicSetDynamicInput( RevealedInformation newDynamicInput, NotificationChain msgs ) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PLAYABLE_TICKET__DYNAMIC_INPUT,
                oldDynamicInput,
                newDynamicInput);
            if (msgs == null)
                msgs = notification;
        ...
        if (newDynamicInput != dynamicInput) {
            ...
            if (dynamicInput != null)
                msgs = ((InternalEObject) dynamicInput).eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - XwPackage.PLAYABLE_TICKET__DYNAMIC_INPUT,
                    null,
                    msgs);
    ...
    public NotificationChain basicSetLatestAnalysis( PrizeAnalysis newLatestAnalysis, NotificationChain msgs ) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PLAYABLE_TICKET__LATEST_ANALYSIS,
                oldLatestAnalysis,
                newLatestAnalysis);
            if (msgs == null)
                msgs = notification;
    ...
    public void setLatestAnalysis( PrizeAnalysis newLatestAnalysis ) {
        if (newLatestAnalysis != latestAnalysis) {
            ...
            if (latestAnalysis != null)
                msgs = ((InternalEObject) latestAnalysis).eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - XwPackage.PLAYABLE_TICKET__LATEST_ANALYSIS,
                    null,
                    msgs);
            if (newLatestAnalysis != null)
                msgs = ((InternalEObject) newLatestAnalysis).eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - XwPackage.PLAYABLE_TICKET__LATEST_ANALYSIS,
                    null,
                    msgs);
            msgs = basicSetLatestAnalysis(
                newLatestAnalysis,
                msgs);
            if (msgs != null)
                msgs.dispatch();
