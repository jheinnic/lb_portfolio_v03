...
public interface ReportPrizeAnalysisRequest extends EObject {
    /**
     * Returns the value of the '<em><b>Prize Analysis</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Prize Analysis</em>' reference isn't clear, there really should be more of
     * a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * {@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.ReportPrizeAnalysisRequest#getPrizeAnalysis
     * <em>Prize Analysis</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Prize Analysis</em>' reference.
