...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Resolved Ticket</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#getFixedDetails <em>
 * Fixed Details</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#getBoardContent <em>
 * Board Content</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#getBonusWord <em>Bonus
 * Word</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#isTwentySpotIncluded
 * <em>Twenty Spot Included</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#getLetterPool <em>
 * Letter Pool</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#isTwentySpotPaid <em>
 * Twenty Spot Paid</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#getBonusValue <em>Bonus
 * Value</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#getPayoutTier <em>
 * Payout Tier</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.ResolvedTicketImpl#getBoardCoverage <em>
 * Board Coverage</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ResolvedTicketImpl extends MinimalEObjectImpl.Container implements ResolvedTicket {
    ...
    /**
     * The default value of the '{@link #getBonusWord() <em>Bonus Word</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @see #getBonusWord()
     * @generated
    ...
    public NotificationChain basicSetFixedDetails( PublishedTicketDetail newFixedDetails, NotificationChain msgs ) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.RESOLVED_TICKET__FIXED_DETAILS,
                oldFixedDetails,
                newFixedDetails);
            if (msgs == null)
                msgs = notification;
     ...
     * @generated
     */
    public void setFixedDetails( PublishedTicketDetail newFixedDetails ) {
        if (newFixedDetails != fixedDetails) {
            NotificationChain msgs = null;
            if (fixedDetails != null)
                msgs = ((InternalEObject) fixedDetails).eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - XwPackage.RESOLVED_TICKET__FIXED_DETAILS,
                    null,
                    msgs);
            if (newFixedDetails != null)
                msgs = ((InternalEObject) newFixedDetails).eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - XwPackage.RESOLVED_TICKET__FIXED_DETAILS,
                    null,
                    msgs);
            msgs = basicSetFixedDetails(
                newFixedDetails,
                msgs);
            if (msgs != null)
                msgs.dispatch();
    ...
    public void setLetterPool( String newLetterPool ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.RESOLVED_TICKET__LETTER_POOL,
                oldLetterPool,
                letterPool));
    }
    ...
    public void setTwentySpotPaid( boolean newTwentySpotPaid ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.RESOLVED_TICKET__TWENTY_SPOT_PAID,
                oldTwentySpotPaid,
                twentySpotPaid));
    }
    ...
    public void setBonusValue( BonusValue newBonusValue ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.RESOLVED_TICKET__BONUS_VALUE,
                oldBonusValue,
                bonusValue));
    }
     ...
     * @generated
     */
    public void setPayoutTier( int newPayoutTier ) {
        int oldPayoutTier = payoutTier;
        payoutTier = newPayoutTier;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.RESOLVED_TICKET__PAYOUT_TIER,
                oldPayoutTier,
                payoutTier));
    }
    ...
    public NotificationChain basicSetBoardCoverage( BoardCoverage newBoardCoverage, NotificationChain msgs ) {
        ...
        // -> return msgs, after adding any generated Notification to it (if it is null, a NotificationChain
    ...
    public NotificationChain eInverseRemove( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch (featureID) {
            case XwPackage.RESOLVED_TICKET__FIXED_DETAILS :
                return basicSetFixedDetails(
                    null,
                    msgs);
            case XwPackage.RESOLVED_TICKET__BOARD_COVERAGE :
                return basicSetBoardCoverage(
                    null,
                    msgs);
        }
    ...
    public void eSet( int featureID, Object newValue ) {
        switch (featureID) {
            case XwPackage.RESOLVED_TICKET__FIXED_DETAILS :
                setFixedDetails((PublishedTicketDetail) newValue);
                return;
            case XwPackage.RESOLVED_TICKET__LETTER_POOL :
            ...
            case XwPackage.RESOLVED_TICKET__BONUS_VALUE :
                ...
                return;
            case XwPackage.RESOLVED_TICKET__PAYOUT_TIER :
                setPayoutTier((Integer) newValue);
                return;
        }
        super.eSet(
            featureID,
    ...
    public void eUnset( int featureID ) {
        switch (featureID) {
            case XwPackage.RESOLVED_TICKET__FIXED_DETAILS :
                setFixedDetails((PublishedTicketDetail) null);
                return;
            case XwPackage.RESOLVED_TICKET__LETTER_POOL :
                setLetterPool(LETTER_POOL_EDEFAULT);
                return;
            case XwPackage.RESOLVED_TICKET__TWENTY_SPOT_PAID :
                setTwentySpotPaid(TWENTY_SPOT_PAID_EDEFAULT);
                return;
            case XwPackage.RESOLVED_TICKET__BONUS_VALUE :
                setBonusValue(BONUS_VALUE_EDEFAULT);
                return;
            case XwPackage.RESOLVED_TICKET__PAYOUT_TIER :
                setPayoutTier(PAYOUT_TIER_EDEFAULT);
                return;
        }
    ...
    public boolean eIsSet( int featureID ) {
        switch (featureID) {
            ...
            case XwPackage.RESOLVED_TICKET__BOARD_CONTENT :
                return BOARD_CONTENT_EDEFAULT == null
                    ? getBoardContent() != null
                    : !BOARD_CONTENT_EDEFAULT.equals(getBoardContent());
            case XwPackage.RESOLVED_TICKET__BONUS_WORD :
                return BONUS_WORD_EDEFAULT == null
                    ? getBonusWord() != null
                    : !BONUS_WORD_EDEFAULT.equals(getBonusWord());
            case XwPackage.RESOLVED_TICKET__TWENTY_SPOT_INCLUDED :
