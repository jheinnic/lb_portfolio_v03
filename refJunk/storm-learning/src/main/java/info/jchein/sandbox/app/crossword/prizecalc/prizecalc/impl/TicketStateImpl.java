...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ticket State</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.TicketStateImpl#getBonusWordIndex
 * <em>Bonus Word Index</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.TicketStateImpl#isTripled <em>
 * Tripled</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.TicketStateImpl#getWordsCompleted
 * <em>Words Completed</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.TicketStateImpl#getIncompleteWords
 * <em>Incomplete Words</em>}</li>
 * <li>
 * {@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.TicketStateImpl#getAvailableLetters
 * <em>Available Letters</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class TicketStateImpl extends MinimalEObjectImpl.Container implements TicketState {
    ...
    /**
     * The default value of the '{@link #isTripled() <em>Tripled</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #isTripled()
     * @generated
    ...
    /**
     * The cached value of the '{@link #isTripled() <em>Tripled</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #isTripled()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getAvailableLetters() <em>Available Letters</em>}' containment
     ...
     * @generated
     */
    public void setBonusWordIndex( int newBonusWordIndex ) {
        int oldBonusWordIndex = bonusWordIndex;
        bonusWordIndex = newBonusWordIndex;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                PrizecalcPackage.TICKET_STATE__BONUS_WORD_INDEX,
                oldBonusWordIndex,
                bonusWordIndex));
    }
     ...
     * @generated
     */
    public void setTripled( boolean newTripled ) {
        boolean oldTripled = tripled;
        tripled = newTripled;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                PrizecalcPackage.TICKET_STATE__TRIPLED,
                oldTripled,
                tripled));
    }
     ...
     * @generated
     */
    public void setWordsCompleted( int newWordsCompleted ) {
        int oldWordsCompleted = wordsCompleted;
        wordsCompleted = newWordsCompleted;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                PrizecalcPackage.TICKET_STATE__WORDS_COMPLETED,
                oldWordsCompleted,
                wordsCompleted));
    }
    ...
    public EList<Integer> getIncompleteWords( ) {
        if (incompleteWords == null) {
            incompleteWords = new EDataTypeUniqueEList<Integer>(
                Integer.class,
                this,
                PrizecalcPackage.TICKET_STATE__INCOMPLETE_WORDS);
        }
    ...
    public EList<AvailableLetter> getAvailableLetters( ) {
        if (availableLetters == null) {
            availableLetters = new EObjectContainmentEList<AvailableLetter>(
                AvailableLetter.class,
                this,
                PrizecalcPackage.TICKET_STATE__AVAILABLE_LETTERS);
        }
    ...
    public NotificationChain eInverseRemove( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch (featureID) {
            case PrizecalcPackage.TICKET_STATE__AVAILABLE_LETTERS :
                return ((InternalEList<?>) getAvailableLetters()).basicRemove(
                    otherEnd,
                    msgs);
        }
    ...
    public void eSet( int featureID, Object newValue ) {
        switch (featureID) {
            case PrizecalcPackage.TICKET_STATE__BONUS_WORD_INDEX :
                setBonusWordIndex((Integer) newValue);
                return;
            case PrizecalcPackage.TICKET_STATE__TRIPLED :
                setTripled((Boolean) newValue);
                return;
            case PrizecalcPackage.TICKET_STATE__WORDS_COMPLETED :
                setWordsCompleted((Integer) newValue);
                return;
            case PrizecalcPackage.TICKET_STATE__INCOMPLETE_WORDS :
                getIncompleteWords().clear();
                getIncompleteWords().addAll(
                    (Collection<? extends Integer>) newValue);
                return;
            case PrizecalcPackage.TICKET_STATE__AVAILABLE_LETTERS :
                getAvailableLetters().clear();
                getAvailableLetters().addAll(
                    (Collection<? extends AvailableLetter>) newValue);
                return;
        }
        super.eSet(
            featureID,
    ...
    public void eUnset( int featureID ) {
        switch (featureID) {
            case PrizecalcPackage.TICKET_STATE__BONUS_WORD_INDEX :
                setBonusWordIndex(BONUS_WORD_INDEX_EDEFAULT);
                return;
            case PrizecalcPackage.TICKET_STATE__TRIPLED :
                setTripled(TRIPLED_EDEFAULT);
                return;
            case PrizecalcPackage.TICKET_STATE__WORDS_COMPLETED :
                setWordsCompleted(WORDS_COMPLETED_EDEFAULT);
                return;
            case PrizecalcPackage.TICKET_STATE__INCOMPLETE_WORDS :
                getIncompleteWords().clear();
                return;
