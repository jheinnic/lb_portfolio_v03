...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Pending Ticket Detail</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PendingTicketDetailImpl#getBoardContent
 * <em>Board Content</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PendingTicketDetailImpl#getBonusWord <em>
 * Bonus Word</em>}</li>
 * <li>
 * {@link info.jchein.sandbox.app.crossword.resources.xw.impl.PendingTicketDetailImpl#isTwentySpotIncluded
 * <em>Twenty Spot Included</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PendingTicketDetailImpl#getAllWords <em>
 * All Words</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PendingTicketDetailImpl#getBasicWords <em>
 * Basic Words</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PendingTicketDetailImpl#getTripleWords
 * <em>Triple Words</em>}</li>
 * <li>{@link info.jchein.sandbox.app.crossword.resources.xw.impl.PendingTicketDetailImpl#isPublishable <em>
 * Publishable</em>}</li>
 * </ul>
 * </p>
 * 
...
public class PendingTicketDetailImpl extends MinimalEObjectImpl.Container implements PendingTicketDetail {
     ...
     * @ordered
     */
    protected static final String BOARD_CONTENT_EDEFAULT =
    ...
    /**
     * The cached value of the '{@link #getBonusWord() <em>Bonus Word</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @see #getBonusWord()
     * @generated
    ...
    /**
     * This is true if the Bonus Word attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
     */
    ...
    /**
     * This is true if the Twenty Spot Included attribute has been set. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     * @ordered
     ...
     * @generated
     */
    public PendingTicketDetailImpl( ) {
        super();
    }
    ...
    public void setBoardContent( String newBoardContent ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PENDING_TICKET_DETAIL__BOARD_CONTENT,
                oldBoardContent,
                boardContent));
    }
    ...
    public void setBonusWord( String newBonusWord ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PENDING_TICKET_DETAIL__BONUS_WORD,
                oldBonusWord,
                bonusWord,
                !oldBonusWordESet));
    }
    ...
    public void setTwentySpotIncluded( boolean newTwentySpotIncluded ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                XwPackage.PENDING_TICKET_DETAIL__TWENTY_SPOT_INCLUDED,
                oldTwentySpotIncluded,
                twentySpotIncluded,
                !oldTwentySpotIncludedESet));
    }
        ...
        switch (featureID) {
            case XwPackage.PENDING_TICKET_DETAIL__BOARD_CONTENT :
                return BOARD_CONTENT_EDEFAULT == null
                    ? boardContent != null
                    : !BOARD_CONTENT_EDEFAULT.equals(boardContent);
            case XwPackage.PENDING_TICKET_DETAIL__BONUS_WORD :
