 ...
 * <ul>
 * <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.AsyncPrizeAnalysisRequest#getTicketHref
...
public interface AsyncPrizeAnalysisRequest extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Revealed Info</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Revealed Info</em>' reference isn't clear, there really should be more of
     * a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * Sets the value of the '
     * {@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.AsyncPrizeAnalysisRequest#getRevealedInfo
     * <em>Revealed Info</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Revealed Info</em>' reference.
     * @see #getRevealedInfo()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Board Coverage</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Board Coverage</em>' reference isn't clear, there really should be more of
     * a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * Sets the value of the '
     * {@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.AsyncPrizeAnalysisRequest#getBoardCoverage
     * <em>Board Coverage</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Board Coverage</em>' reference.
