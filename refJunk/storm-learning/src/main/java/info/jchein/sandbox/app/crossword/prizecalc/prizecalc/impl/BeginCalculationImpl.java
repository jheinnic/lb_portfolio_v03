...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Begin Calculation</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.BeginCalculationImpl#getTicketHref
 * <em>Ticket Href</em>}</li>
 * <li>
 * {@link info.jchein.sandbox.app.crossword.prizecalc.prizecalc.impl.BeginCalculationImpl#getTicketState
    ...
    public void setTicketHref( String newTicketHref ) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                this,
                Notification.SET,
                PrizecalcPackage.BEGIN_CALCULATION__TICKET_HREF,
                oldTicketHref,
                ticketHref));
    }
            ...
            if (ticketState != oldTicketState) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                        ...
                        PrizecalcPackage.BEGIN_CALCULATION__TICKET_STATE,
                        oldTicketState,
                        ticketState));
            }
        }
