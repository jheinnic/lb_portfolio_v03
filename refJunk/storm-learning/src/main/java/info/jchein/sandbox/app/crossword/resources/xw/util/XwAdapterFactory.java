...
public class XwAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected XwSwitch<Adapter> modelSwitch = new XwSwitch<Adapter>() {
        @Override
     ...
     * <em>Pending Ticket Detail</em>}'. <!-- begin-user-doc --> This default implementation returns null so
     ...
     * <em>Published Ticket Detail</em>}'. <!-- begin-user-doc --> This default implementation returns null
     ...
     * <em>Abstract Word Coverage</em>}'. <!-- begin-user-doc --> This default implementation returns null
     * so that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
     * cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
     ...
     * <em>Revealed Information</em>}'. <!-- begin-user-doc --> This default implementation returns null so
     * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
     * cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
