(function(angular) {
    ...
    LoginController.$inject = ['$state', 'IdentityContext', 'authTokenStatus', 'loginKind', 'LOGIN_KIND_ENUM', 'AUTH_TOKEN_EVENT_TYPE'];

    function LoginController(IdentityContextService, $state, appContextStatus, loginKind, LOGIN_KIND_ENUM) {
	...
	// kind of feedback the user is given.
        ...
        if (angular.isUndefined(identityContextStatus)) {
