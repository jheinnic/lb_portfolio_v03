(function (console) {
  ...
  module.exports = function replication(app) {
    var LocalSeriesPlayFamily = app.models.LocalSeriesPlayFamily;
    var LocalSeriesPool = app.models.LocalSeriesPool;
    var RemoteSeriesPlayFamily = app.models.RemoteSeriesPlayFamily;
    var RemoteSeriesPool = app.models.RemoteSeriesPool;

    var modelPairs = [
      {app: app, local: LocalSeriesPlayFamily, remote: RemoteSeriesPlayFamily},
      {app: app, local: LocalSeriesPool, remote: RemoteSeriesPool}
    ];
