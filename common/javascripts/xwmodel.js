function TicketDocument() {
    ...
    this.yourLetters = "__________________";
    this.bonusWord = null;
    this.bonusValue = null;
    this.twentySpotAvailable = null;
    this.twentySpotHit = false;
    ...
    this.isTwentySpotAvailable = function isTwentySpotAvailable() {
        return this.twentySpotAvailable;
    };

    this.setTwentySpotAvailable = function setTwentySpotAvailable(boolVal) {
        if ((typeof boolVal) != 'boolean') {
            throw "IllegalArgument";
        }

        this.twentySpotAvailable = boolVal;
    };

    this.isTwentySpotAvailableSet = function isTwentySpotAvailableSet() {
        return this.twentySpotAvailable != null;
    };

    this.unsetTwentySpotAvailable = function unsetTwentySpotAvailable() {
        this.twentySpotAvailable = null;
    };
    ...
    this.isPublishable = function isPublishable() {
        if (this.bonusWord != null && this.twentySpotAvailable != null) {
